...
testColorOf = do
    ...
    let placedBlock1 = PlacedBlock { block = Block {blockHeight=1, blockWidth=2, color=White}, topLeftCorner = position1}
    let colorOf1 = colorOf placedBlock1 == White
...
testColorAt = do
    ...
    let colorAt1 = colorAt position1 board == Just White
